...
/**
 * The wpc_ layer: mode helpers, activation, setup screen, update checker and
 * module loading. Required by wpconnector.php once the PHP version check has
 * passed, so PHP 7.0+ syntax is safe here and in everything loaded below.
 */
...
add_filter('plugin_action_links_' . plugin_basename(WPC_PLUGIN_FILE), function (array $links): array {
